...
<div class="min-w-[380px] w-[660px] h-full transition-all ">
  <div class="aspect-h-full aspect-w-full lg:aspect-h-full lg:aspect-w-full sm:overflow-hidden sm:rounded-lg">
    <img  :src="require('../../assets/images/product_07_large.png')"  alt="" class="w-full h-38 object-cover"/>
          </div>
   </div>
 <div class="w-full h-full">
        ...
        <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div class="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <form class="mt-10">
              ...
              <router-link :to="{name:'Cart'}"  class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Add to Cart</router-link>
            </form>
          </div>
  ...
  const product = {
    ...
    href: '#',
    breadcrumbs: [
      { id: 1, name: 'Medical Care', href: '#' },
      { id: 2, name: 'Pain Relievers', href: '#' },
    ],
    images: [
      {
