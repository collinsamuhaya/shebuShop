<template>
  <!-- ======= Banner ======= -->
  <div class="relative isolate flex gap-x-2 overflow-hidden bg-gray-50 px-6 py-1.5 sm:px-3.5 sm:before:flex-0">
  
    <router-link :to="{name:''}" class="flex py-2 px-4 border border-transparent text-sm rounded-md font-semibold bg-transparent hover:bg-gray-100 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
  ...
  <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
    ...
    <div class="flex items-center gap-x-4 gap-y-2 ml-auto">
              ...
              <Menu as="div" class="relative ml-3">
                <div>
                  <MenuButton class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <img class="h-8 w-8 rounded-full" :src="user.userimage" alt="" />
                  </MenuButton>
                </div>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            <div class="flex-shrink-0">
              <img class="h-10 w-10 rounded-full" :src="user.userimage" alt="" />
            </div>
            <div class="ml-3">
...
store.dispatch('logout')
     .then(()=>{router.push({name:'UserDashboard' })})
